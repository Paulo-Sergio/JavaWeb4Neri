...
<div class="row">
	<table class="table table-bordered table-striped">
		<tr>
			<th width="32"><a href="BairroServlet?ordenacao=id&numpagina=${param.numpagina == null ? '1' : param.numpagina}&pesquisa=${param.pesquisa}&campopesquisa=${param.campopesquisa}">Código</a></th>
			<th><a href="BairroServlet?ordenacao=descricao&numpagina=${param.numpagina == null ? '1' : param.numpagina}&pesquisa=${param.pesquisa}&campopesquisa=${param.campopesquisa}">Descrição</a></th>
