...
<%
	...
	// qual a ordenacao
	String ordenacao = request.getParameter("ordenacao") == null ? "nome" : request.getParameter("ordenacao");
	...
	String campoPesquisa = request.getParameter("campopesquisa") == null ? "nome" : request.getParameter("campopesquisa");
%>
